...
class Participant {
  ...
  dispatchMessage = (text) => {
    const a = this.prepareMessage(text);
    if (this.communicator === SMSCommunicator) {
      SMSCommunicator.transmit(a);
    } else if (this.communicator === EmailCommunicator) {
      EmailCommunicator.transmit(a);
    } else {
      console.log("Невірний тип комунікатора");
    }
  };
